...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        # TODO: YOUR CODE HERE
        return [
            ("The room in which you begin. Its only identifying piece is a large"
            " stuffed gazelle in the corner who's eyes follow your every move"),
            "You are in the room with the large fireplace",
            "You are in the room that smells faintly of cinnamon",
            ("This room is unlit and with every step your shins are bruised by"
            " unseen obstacles."),
    ...
    def get_input(self):
        ...
        recieved = b''
        while b'\n' not in recieved:
            recieved += self.client_connection.recv(16)
    ...
    def move(self, argument):
        ...
        * "west"
        ...
        if self.room == 0 and argument == 'north':
            ...
            self.output_buffer = "You can't move that way!"
            return None
